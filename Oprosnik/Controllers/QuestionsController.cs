...
namespace Oprosnik.Controllers
{
    ...
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text_Quest,Scores")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text_Quest,Scores")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
